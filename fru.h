...
fru_chassis_area_t * fru_encode_chassis_info(const fru_exploded_chassis_t *chassis, bool simple_text);
bool fru_decode_chassis_info(const fru_chassis_area_t *area, fru_exploded_chassis_t *chassis_out);
fru_board_area_t * fru_encode_board_info(const fru_exploded_board_t *board, bool simple_text);
bool fru_decode_board_info(const fru_board_area_t *area, fru_exploded_board_t *board_out);
fru_product_area_t * fru_encode_product_info(const fru_exploded_product_t *product, bool simple_text);
